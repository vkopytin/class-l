...
module srv {
    ...
    // TODO: Implement weather support for Fenix 7.
    module weather {
        ...
        function draw(dc as Graphics.Dc) as Void {
            self.drawWeatherIcon(dc, cfg.weatherX - 50, cfg.weatherY - 8, cfg.weatherX, self.color);
            self.drawTemperature(dc, cfg.weatherX - 8, cfg.weatherY - 6, false, self.color);
        }
